...
public class Green_Laser_Mk2 extends Tower {
    ...
    // Shoot fungere på samme måde som Green_Laser_Mk1 untagen at en ekstra skal
    // blive skudt
    public void shoot(Graphics g) {
        if (Vectoid.listOfVectoids[target].dead == false && inRange(target) == true) {
            ...
            if (Vectoid.listOfVectoids[bounceTarget].dead == false && inRangeVectoid(bounceTarget) == true) {
                ...
                g.setColor(Color.green);
                g.drawLine(Vectoid.listOfVectoids[target].x + Vectoid.radius / 2,
                        Vectoid.listOfVectoids[target].y + Vectoid.radius / 2,
                        Vectoid.listOfVectoids[bounceTarget].x + Vectoid.radius / 2,
                        Vectoid.listOfVectoids[bounceTarget].y + Vectoid.radius / 2);
