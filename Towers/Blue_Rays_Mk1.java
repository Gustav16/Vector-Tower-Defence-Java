...
public class Blue_Rays_Mk1 extends Tower {

    // arraliste over alle tårne af denne type
    public static Blue_Rays_Mk1 towers[] = new Blue_Rays_Mk1[100];
    ...
    public Blue_Rays_Mk1(int squareX, int squareY) {
        super(squareX, squareY);
        imagePath = "Images/Blue_Rays_Mk1.png";
        range = 250;
        damage = 100;
    ...
    public static void buy(int x, int y) {
        ...
        if (x < 15 && y < 15 && x >= 0 && y >= 0 && Square.grid[x][y].isTowerPlacebel == true
            ...
            towers[count] = new Blue_Rays_Mk1(x, y);
