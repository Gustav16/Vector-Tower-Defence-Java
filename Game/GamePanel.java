...
import Towers.Blue_Rays_Mk1;
import Towers.Blue_Rays_Mk2;
...
public class GamePanel extends JPanel implements Runnable, MouseMotionListener, MouseListener {
    ...
    // den function som bliver opdateret hver frame. Alle grafiske elemnter er inde
    // i denen function
    ...
    public void mouseClicked(MouseEvent e) {
        ...
        } else if (followMouseImage == "Images/Blue_Rays_Mk1.png") {

            Blue_Rays_Mk1.buy(x, y);

        } else if (followMouseImage == "Images/Blue_Rays_Mk2.png") {

            Blue_Rays_Mk2.buy(x, y);
        }
    }
